...
import co.i014114.www.taller2.Adapters.MyAdapterCountry;
import co.i014114.www.taller2.Connection.HttpManager;
import co.i014114.www.taller2.Models.MyCountry;
import co.i014114.www.taller2.Parser.MyJsonCountry;
...
public class CountriesActivity extends AppCompatActivity {
    ...
    private MyAdapterCountry adapterCountry;
...
// Validar el estado obtenido de la conexion
    ...
    public class TaskCountry extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                countryList = MyJsonCountry.getData(s);
    ...
    public void processData() {
        adapterCountry = new MyAdapterCountry(countryList, getApplicationContext());
